...
export function tempCHTGaugeR(canvasId, tabGrad, unit, gradMin, gradMax, affPosVert, affPostHor, arc11, arc12, arc21, arc22, arc31, arc32, isDoubleGauge) {
    //*********************************************************************************************
    ...
    if (canvasParent && !isDoubleGauge) {
        ...
        customDisplay.className = 'tempCHTGaugeR-value-display';
    ...
    tempCHTGaugeR.setRawValue(parseFloat(gradMax));
    tempCHTGaugeR.draw();
