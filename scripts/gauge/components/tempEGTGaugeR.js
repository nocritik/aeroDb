...
export function tempEGTGaugeR(canvasId, tabGrad, unit, gradMin, gradMax, affPosVert, affPostHor, arc11, arc12, arc21, arc22, arc31, arc32, isDoubleGauge) {
    //*********************************************************************************************
    ...
    if (canvasParent && !isDoubleGauge) {
        ...
        customDisplay.className = 'tempEGTGaugeR-value-display';
    ...
    tempEGTGaugeR.setRawValue(parseFloat(gradMax));
    tempEGTGaugeR.draw();
