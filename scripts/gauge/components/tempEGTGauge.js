...
export function tempEGTGauge(canvasId, tabGrad, unit, gradMin, gradMax, affPosVert, affPostHor, arc11, arc12, arc21, arc22, arc31, arc32) {
    var tempEGTGauge = new Gauge({
