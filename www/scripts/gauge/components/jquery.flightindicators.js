...
(function($) {
	function FlightIndicator( placeholder, type, options ) {
		...
		placeholder.each(function(){
			switch(type){
				case 'heading':
					$(this).html('<div class="instrument heading">\n\
                                        \n\
				...
				break;
				case 'variometer':
					$(this).html('<div class="instrument vario">\n\
                                        \n\
                                        <img src="' + settings.img_directory + 'vertical_mechanics.svg" class="box" alt="" />\n\
                                        <div class="vario box"><img src="' + settings.img_directory + 'fi_needle.svg" class="box" alt="" />\n\
                                        </div><div class="mechanics box">\n\
                                        <img src="' + settings.img_directory + 'fi_circle.svg" class="box" alt="" />\n\
                                        </div></div>');
				...
				case 'turn_coordinator':
					$(this).html('<div class="instrument turn_coordinator">\n\
                                        \n\
                                        <img src="' + settings.img_directory + 'turn_coordinator.svg" class="box" alt="" />\n\
				...
				case 'airspeed':
					$(this).html('<div class="instrument airspeed">\n\
                                        \n\
                                        <img src="' + settings.img_directory + 'speed_mechanics.svg" class="box" alt="" />\n\
                                        <div class="speed box"><img src="' + settings.img_directory + 'fi_needle.svg" class="box" alt="" />\n\
                                        </div><div class="mechanics box">\n\
                                        <img src="' + settings.img_directory + 'fi_circle.svg" class="box" alt="" />\n\
                                        </div></div>');
				...
				break;
				default:
					$(this).html('<div class="instrument attitude">\n\
                                        \n\
                                        <div class="roll box"><img src="' + settings.img_directory + 'horizon_back.svg" class="box" alt="" />\n\
                                        <div class="pitch box"><img src="' + settings.img_directory + 'horizon_ball.svg" class="box" alt="" />\n\
                                        </div><img src="' + settings.img_directory + 'horizon_circle.svg" class="box" alt="" />\n\
                                        </div><div class="mechanics box">\n\
                                        <img src="' + settings.img_directory + 'horizon_mechanics.svg" class="box" alt="" />\n\
                                        <img src="' + settings.img_directory + 'fi_circle.svg" class="box" alt="" />\n\
                                        </div></div>');
