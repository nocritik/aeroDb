 ...
 */
//*********************************************************************************************
//                          water temperature demi gauge right
//*********************************************************************************************
// MODIFICATION: Ajout du paramètre canvasId pour supporter plusieurs jauges du même type
export function tempWaterGaugeR(canvasId, tabGrad, unit, gradMin, gradMax, affPosVert, affPostHor, arc11, arc12, arc21, arc22, arc31, arc32, isDoubleGauge) {
    ...
    if (canvasParent && !isDoubleGauge) {
        ...
        customDisplay.className = 'tempWaterGaugeR-value-display';
    ...
    tempWaterGaugeR.setRawValue(parseFloat(gradMax));
    tempWaterGaugeR.draw();
};
